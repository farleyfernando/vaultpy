...
![Tests](https://github.com/farleyfernando/vaultpy/actions/workflows/ci.yml/badge.svg?branch=main)
![Coverage](https://codecov.io/gh/farleyfernando/vaultpy/branch/main/graph/badge.svg)
![Python](https://img.shields.io/badge/python-3.14%2B-3776AB?logo=python&logoColor=white)
![Windows](https://img.shields.io/badge/windows-compatible-0078D4?logo=windows&logoColor=white)

The tests badge reflects the GitHub Actions workflow status, and the coverage badge reflects the latest Codecov upload from CI.
